...
public class ArrayAdapterSearchView extends SearchView {
    private CustomAutoCompleteTextView mSearchAutoComplete;
    ...
    public void initialize() {
       // mSearchAutoComplete = (SearchAutoComplete) findViewById(android.support.v7.appcompat.R.id.search_src_text);
        mSearchAutoComplete = (CustomAutoCompleteTextView) findViewById(android.support.v7.appcompat.R.id.search_src_text);
